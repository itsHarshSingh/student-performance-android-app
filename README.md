...
## ✨ Features
- **Interactive UI:** Clean, modern, and user-friendly XML-based design tailored for academic inputs.
- **Real-Time API Integration:** Seamlessly communicates via network requests with a cloud-hosted Flask ML backend.
- **Instant Results:** Takes user inputs (Study Hours, Attendance, and Previous Score) and dynamically displays the predicted final score.
